...
export default function Event() {
  ...
  return (
    <div className='grid grid-cols-1 justify-items-center sm:gap-x-4 gap-y-8 sm:grid-cols-2 lg:grid-cols-3 py-4 px-4 sm:px-6 lg:px-8'>
      ...
      {showModal1 && <Modal setShowModal={setShowModal1} descr="one is working fine" />}
      ...
      <div class="max-w-sm bg-white border border-green-700 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
        ...
        <div class="p-5">
          ...
          <div className='flex justify-between'>
            ...
            <button onClick={() => setShowModal2(true)} class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-green-700 rounded-lg hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">
              Winners
              <svg class="rtl:rotate-180 w-3.5 h-3.5 ms-2" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 10">
                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M1 5h12m0 0L9 1m4 4L9 9" />
              </svg>
      ...
      {showModal2 && <Modal setShowModal={setShowModal2} descr="two is working fine"/>}
      <div class="max-w-sm bg-white border border-green-700 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
        <a href="#">
          <img class="rounded-t-lg" src={e1} alt="" />
        </a>
