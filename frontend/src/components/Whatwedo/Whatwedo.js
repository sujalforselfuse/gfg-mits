        ...
        <div>
            <div class="dark:bg-gray-800 bg-white">
                ...
                <div className="flex items-center flex-col gap-1 justify-center w-full">
                    ...
                    <h1 className='dark:text-green-500 text-black font-bold text-3xl'>
                        Explore Now
                    </h1>

                    <p className='text-lg dark:text-gray-400 text-gray-800 font-normal text-center'>
                    Immerse yourself in a realm of innovation, skill-building, and personal growth through our diverse range of engaging events.
                    </p>
